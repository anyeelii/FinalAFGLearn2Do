...
func _on_StartList_item_selected(index):
	...
	#Code for "going back"
		...
		# source: https://www.youtube.com/watch?v=XHbrKdsZrxY&t=530s
...
# source: https://www.youtube.com/watch?v=K-F_wgb6fqs
func settings():
	Title.text = "Settings"
	StartList.clear()
	if Backgroundsound.playing:
...
# source: https://godotengine.org/qa/2547/how-to-randomize-a-list-array
